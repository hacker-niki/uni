...
uint8_t pins[] = {IK_PIN1, IK_PIN2, IK_PIN3, IK_PIN4, IK_PIN5};
...
void setup_ik();
void serial_ik_monitor();
void FFT(int in[], int N, float Frequency);
void add_data(int *data, int size, uint8_t pin);
...
{
    Serial.print("A0:");
    Serial.print(analogRead(IK_PIN1));
    Serial.print(",");

    Serial.print("A1:");
    Serial.print(analogRead(IK_PIN2));
    Serial.print(",");

    Serial.print("A2:");
    Serial.print(analogRead(IK_PIN3));
    Serial.print(",");

    Serial.print("A3:");
    Serial.print(analogRead(IK_PIN4));
    Serial.print(",");

    Serial.print("A4:");
    Serial.println(analogRead(IK_PIN5));
}
...
void setup_ik()
{
    ...
    pinMode(IK_PIN3, INPUT);

    pinMode(IK_PIN4, INPUT);

    pinMode(IK_PIN5, INPUT);
}

void add_data(int *data, int size, uint8_t pin)
{
    byte input = analogRead(pin);
