...
<head>
    <meta charset="UTF-8">
    <title>ГОСТ 28147-89 | Шифрование и Имитовставка</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">
    <div class="container mt-5 mb-5" style="max-width: 800px;">
        <div class="card shadow-sm">
            <h1 class="card-header bg-primary text-white p-3 text-center">ГОСТ 28147-89</h1>
            <div class="card-body p-4">
                <!-- Форма теперь отправляет данные в handler.php -->
                ...
                <?php if ($result): ?>
                    <div class="mt-4">
                        ...
                        <div class="p-3 rounded bg-secondary-subtle text-center font-monospace fs-5" style="word-wrap: break-word;">
