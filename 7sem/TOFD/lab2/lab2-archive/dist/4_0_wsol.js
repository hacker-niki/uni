...
async function wrapSol() {
    const amount = 0.5 * LAMPORTS_PER_SOL; // 1 SOL
    const ata = await getAssociatedTokenAddress(NATIVE_MINT, owner.publicKey);
    const tx = new Transaction().add(createAssociatedTokenAccountInstruction(owner.publicKey, ata, owner.publicKey, NATIVE_MINT), SystemProgram.transfer({
...
wrapSol();
//# sourceMappingURL=4_0_wsol.js.map